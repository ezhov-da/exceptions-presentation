...
public class App1 {
     ...
     * <p>
     * Всё верно, в случае, если нам необходимо сделать в lambda выражении действие над списком используя
     * метод с непроверяемым исключение, нам приходить жонглировать с обработкой исключений.
     * <p>
     * Как с этим жить?
     * <p>
     * В первую очередь задачть себе вопрос: "А действительно ли я делаю то, что надо?"
     * <p>
    ...
    public static void main(String[] args) {
        ...
        //Нехватка метода получения книг по ID
