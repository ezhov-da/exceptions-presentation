...
public class App1 {
     ...
     * <p>
     * Это позволило нам:
     * 1. разделить зоны ответственности и дообогатить ошибку на каждом уровне дополнителльной информацией
     * 2. заложить возможность не нарушать принцип Лисков при создании других реализаций наших интерфейсов.
     * <p>
     * Если посмотреть выше, разделение исключений по слоям позволит вводить новые исключения и
     * реагировать на них в случае необходимости на уровне представления.
     *
     * Презентация "Проверяемые исключения зло!", потом
