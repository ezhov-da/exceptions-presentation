...
/**
 * Итак, предположим, что книги у нас хронятся в JSON, тогда используем для их чтения Jackson.
...
public class App2 {
     ...
     * <p>
     * На самом верхнем уровне мы получаем информацию непосредственно из хранилища о том, что произошда ошибка.
     *
