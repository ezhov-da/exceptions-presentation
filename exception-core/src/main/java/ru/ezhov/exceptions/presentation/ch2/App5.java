...
public class App5 {
    ...
    private static class BookService {
         ...
         * <p>
         * Обёртывание нашего проверяемого исключения в непроверяемоого!!!
         * <p>
         ...
         * <p>
         * Для того, чтоб была выстроена правильная коммуникация с пользователем, нам необходимо дать понять пользователю что пошло не так.
