...
public class App2 {
     ...
     * <p>
     * В таком случае из-за неконтролируемого возбужденя ошибки вся информация о входных параметрах теряется и в логах мы увидим
     * только ID книги, который может быть не самым важным для анализа проблемы или ошибки в сценарии.
     *
     * @see App3
     */
